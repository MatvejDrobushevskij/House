...
func CreateKitchenSet() KitchenSet {
 ...
 for i := 0; i < 4; i++ {
  chairsSlice = append(chairsSlice, chair{
   Furniture: Furniture{
    Name:     "Стул",
    Material: "Дерево",
    Length:   49,
  ...
  wallCabinetSlice = append(wallCabinetSlice, wallCabinet{
   Furniture: Furniture{
    Name:     "Подвесной шкаф",
    Material: "Дерево",
    Length:   50,
  ...
  floorCabinetSlice = append(floorCabinetSlice, floorCabinet{
   Furniture: Furniture{
    Name:     "Кухонный стол",
    Material: "Дерево",
    Length:   50,
 ...
 kSet := KitchenSet{
  Chairs:        chairsSlice,
  FloorCabinets: floorCabinetSlice,
  Table:         Table,
  WallCabinets:  wallCabinetSlice,
 }
